export class Config {
    ...
    constructor(rpc_url) {
        ...
        const ret = wasm.config_new(ptr0, len0);
        this.__wbg_ptr = ret;
...
export class WebClient {
     ...
     * @returns {Promise<any>}
     */
    aspMembershipContractState() {
        const ret = wasm.webclient_aspMembershipContractState(this.__wbg_ptr);
        return takeObject(ret);
    }
    /**
     * @returns {Promise<any>}
     */
    aspNonmembershipContractState() {
        const ret = wasm.webclient_aspNonmembershipContractState(this.__wbg_ptr);
        return takeObject(ret);
    }
    /**
     * @returns {any}
    ...
    /**
     * @param {string} address
     * @param {Uint8Array} spending_sig
     * @param {Uint8Array} encryption_sig
     * @returns {Promise<void>}
     */
    deriveAndSaveUserKeys(address, spending_sig, encryption_sig) {
        const ptr0 = passStringToWasm0(address, wasm.__wbindgen_export, wasm.__wbindgen_export2);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passArray8ToWasm0(spending_sig, wasm.__wbindgen_export);
        const len1 = WASM_VECTOR_LEN;
        const ptr2 = passArray8ToWasm0(encryption_sig, wasm.__wbindgen_export);
        const len2 = WASM_VECTOR_LEN;
        const ret = wasm.webclient_deriveAndSaveUserKeys(this.__wbg_ptr, ptr0, len0, ptr1, len1, ptr2, len2);
        return takeObject(ret);
    }
    /**
     ...
     * @returns {string}
     */
    encryptionDerivationMessage() {
        let deferred1_0;
        let deferred1_1;
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.webclient_encryptionDerivationMessage(retptr, this.__wbg_ptr);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            deferred1_0 = r0;
            deferred1_1 = r1;
     ...
     * @returns {Promise<any>}
     */
    getRecentPoolActivity(limit) {
        const ret = wasm.webclient_getRecentPoolActivity(this.__wbg_ptr, limit);
        return takeObject(ret);
    }
    /**
     * @param {number} limit
     ...
     */
    poolContractState() {
        const ret = wasm.webclient_poolContractState(this.__wbg_ptr);
        return takeObject(ret);
    }
    /**
     * @param {string} user_address
     * @param {bigint} membership_blinding
     * @param {bigint} amount_stroops
     * @param {Array<any>} output_amounts
     * @param {Function | null} [on_status]
     * @returns {Promise<any>}
     */
    proveDeposit(user_address, membership_blinding, amount_stroops, output_amounts, on_status) {
        const ptr0 = passStringToWasm0(user_address, wasm.__wbindgen_export, wasm.__wbindgen_export2);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.webclient_proveDeposit(this.__wbg_ptr, ptr0, len0, addHeapObject(membership_blinding), addHeapObject(amount_stroops), addHeapObject(output_amounts), isLikeNone(on_status) ? 0 : addHeapObject(on_status));
        return takeObject(ret);
    }
    /**
     * @param {string} user_address
     ...
     * @param {bigint} ext_amount_stroops
     ...
     * @returns {Promise<any>}
     */
    proveTransact(user_address, membership_blinding, ext_recipient, ext_amount_stroops, input_note_ids, output_amounts, out_recipient_note_keys_hex, out_recipient_enc_keys_hex, on_status) {
        const ptr0 = passStringToWasm0(user_address, wasm.__wbindgen_export, wasm.__wbindgen_export2);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(ext_recipient, wasm.__wbindgen_export, wasm.__wbindgen_export2);
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.webclient_proveTransact(this.__wbg_ptr, ptr0, len0, addHeapObject(membership_blinding), ptr1, len1, addHeapObject(ext_amount_stroops), addHeapObject(input_note_ids), addHeapObject(output_amounts), addHeapObject(out_recipient_note_keys_hex), addHeapObject(out_recipient_enc_keys_hex), isLikeNone(on_status) ? 0 : addHeapObject(on_status));
        return takeObject(ret);
    }
    /**
     * @param {string} user_address
     ...
     * @returns {Promise<any>}
     */
    proveTransfer(user_address, membership_blinding, recipient_note_key_hex, recipient_enc_key_hex, input_note_ids, output_amounts, on_status) {
        const ptr0 = passStringToWasm0(user_address, wasm.__wbindgen_export, wasm.__wbindgen_export2);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(recipient_note_key_hex, wasm.__wbindgen_export, wasm.__wbindgen_export2);
        const len1 = WASM_VECTOR_LEN;
        const ptr2 = passStringToWasm0(recipient_enc_key_hex, wasm.__wbindgen_export, wasm.__wbindgen_export2);
        const len2 = WASM_VECTOR_LEN;
        const ret = wasm.webclient_proveTransfer(this.__wbg_ptr, ptr0, len0, addHeapObject(membership_blinding), ptr1, len1, ptr2, len2, addHeapObject(input_note_ids), addHeapObject(output_amounts), isLikeNone(on_status) ? 0 : addHeapObject(on_status));
        return takeObject(ret);
    }
    /**
     * @param {string} user_address
     ...
     * @returns {Promise<any>}
     */
    proveWithdraw(user_address, membership_blinding, withdraw_recipient, input_note_ids, on_status) {
        const ptr0 = passStringToWasm0(user_address, wasm.__wbindgen_export, wasm.__wbindgen_export2);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(withdraw_recipient, wasm.__wbindgen_export, wasm.__wbindgen_export2);
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.webclient_proveWithdraw(this.__wbg_ptr, ptr0, len0, addHeapObject(membership_blinding), ptr1, len1, addHeapObject(input_note_ids), isLikeNone(on_status) ? 0 : addHeapObject(on_status));
        return takeObject(ret);
    }
    /**
     * @returns {string}
    ...
    spendingKeyMessage() {
        ...
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.webclient_spendingKeyMessage(retptr, this.__wbg_ptr);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            deferred1_0 = r0;
            deferred1_1 = r1;
...
function __wbg_get_imports() {
    const import0 = {
        ...
        __wbg_new_typed_1137602701dc87d4: function(arg0, arg1) {
            try {
                ...
                var cb0 = (arg0, arg1) => {
                    ...
                    state0.a = 0;
                    try {
                        return __wasm_bindgen_func_elem_6096(a, state0.b, arg0, arg1);
                    } finally {
                        state0.a = a;
                    }
                };
        ...
        __wbindgen_cast_0000000000000001: function(arg0, arg1) {
            // Cast intrinsic for `Closure(Closure { owned: true, function: Function { arguments: [Externref], shim_idx: 976, ret: Result(Unit), inner_ret: Some(Result(Unit)) }, mutable: true }) -> Externref`.
        ...
        __wbindgen_cast_0000000000000002: function(arg0, arg1) {
            ...
            const ret = makeClosure(arg0, arg1, __wasm_bindgen_func_elem_803);
            return addHeapObject(ret);
        },
        __wbindgen_cast_0000000000000003: function(arg0, arg1) {
            ...
            const ret = makeMutClosure(arg0, arg1, __wasm_bindgen_func_elem_2242);
            return addHeapObject(ret);
        },
        __wbindgen_cast_0000000000000004: function(arg0, arg1) {
            // Cast intrinsic for `Closure(Closure { owned: true, function: Function { arguments: [], shim_idx: 971, ret: Unit, inner_ret: Some(Unit) }, mutable: true }) -> Externref`.
            const ret = makeMutClosure(arg0, arg1, __wasm_bindgen_func_elem_6032);
            return addHeapObject(ret);
        },
...
function __wasm_bindgen_func_elem_2242(arg0, arg1) {
    wasm.__wasm_bindgen_func_elem_2242(arg0, arg1);
}

function __wasm_bindgen_func_elem_6032(arg0, arg1) {
    wasm.__wasm_bindgen_func_elem_6032(arg0, arg1);
}

function __wasm_bindgen_func_elem_803(arg0, arg1, arg2) {
    wasm.__wasm_bindgen_func_elem_803(arg0, arg1, addHeapObject(arg2));
}

function __wasm_bindgen_func_elem_6093(arg0, arg1, arg2) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.__wasm_bindgen_func_elem_6093(retptr, arg0, arg1, addHeapObject(arg2));
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        if (r1) {
            throw takeObject(r0);
...
function __wasm_bindgen_func_elem_6096(arg0, arg1, arg2, arg3) {
    wasm.__wasm_bindgen_func_elem_6096(arg0, arg1, addHeapObject(arg2), addHeapObject(arg3));
}
